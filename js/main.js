    ...
    tbquire(['ias'], function() {
        if( !jsui.bd.hasClass('site-minicat') && $('.excerpt').length ){
            $.ias({
                ...
                next: '.next-page a',
                loader: '<div class="pagination-loading"><img src="//cdn.jsdelivr.net/gh/lsza/cdn@1.0/img/loading.gif"></div>',
                trigger: 'More',
                onRenderComplete: function() {
                    tbquire(['lazyload'], function() {
                        $('.excerpt .thumb').lazyload({
                            data_attribute: 'src',
                            placeholder: '//cdn.jsdelivr.net/gh/lsza/cdn@1.0/img/thumbnail.png', 
                            threshold: 400
                        });
                    });
                }
...
tbquire(['lazyload'], function() {
    $('.avatar').lazyload({
        data_attribute: 'src',
        placeholder: '//cdn.jsdelivr.net/gh/lsza/cdn@1.0/img/avatar-default.png',
        threshold: 400
    })
